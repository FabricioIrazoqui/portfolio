...
export const CardData = proyects?.map((proyect, key) => (
    <div key={key} className="p-4 md:p-8 md:w-[90%] relative">
        {proyect.name ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-center justify-center relative h-fit">
            <div>
                {proyect.description ? (
                    <div className=" md:p-8 p-2 md:overflow-y-auto">
